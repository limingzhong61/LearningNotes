...
- 映射文件的命名规则
 - 表所对应的实体类的类名+Mapper.xml
   ...
   - MyBatis映射文件存放的位置是src/main/resource/mappers目录下
...
1. 查询的标签select必须**设置属性resultType或resultMap**，用于设置实体类和数据库表的映射关系  
