...
![img](img_Java%E5%9F%BA%E7%A1%80-%E5%BC%82%E5%B8%B8%E6%9C%BA%E5%88%B6%E8%AF%A6%E8%A7%A3/java-basic-exception-1.png)
...
注意：**若是父类的方法没有声明异常，则子类继承方法后，也不能申明异常。**
...
- ![img](img_Java%E5%9F%BA%E7%A1%80-%E5%BC%82%E5%B8%B8%E6%9C%BA%E5%88%B6%E8%AF%A6%E8%A7%A3/java-basic-exception-2.jpg)
- 一个完整的例子
...
> 很多时候，开发者很有自信不会抛出异常，因此写了一个catch块，但是**没有做任何处理或者记录日志。**
...
try块中的return语句执行成功后，并不马上返回，而是**继续执行finally块中的语句，如果此处存在return语句，则在此直接返回，无情丢弃掉try块中的返回点。**
...
提到JVM处理异常的机制，就需要提及**Exception Table，以下称为异常表**。我们暂且不急于介绍异常表，先看一个简单的 Java 处理异常的小例子。
...
- 6.如果**当前Thread为最后一个非守护线程，且未处理异常，则会导致JVM终止运行**。
...
我们在**代码中的catch的顺序决定了异常处理者在异常表的位置，所以，越是具体的异常要先处理**，否则就会出现下面的问题
