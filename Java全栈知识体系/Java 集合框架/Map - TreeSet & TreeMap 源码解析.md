...
![TreeMap_base.png](img_Map%20-%20TreeSet%20&%20TreeMap%20%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90/TreeMap_base.png)出于性能原因，*TreeMap*是非同步的(not synchronized)，如果需要在多线程环境使用，需要程序员手动同步；或者通过如下方式将*TreeMap*包装成(wrapped)同步的:
...
![TreeMap_rotateLeft.png](img_Map%20-%20TreeSet%20&%20TreeMap%20%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90/TreeMap_rotateLeft.png)*TreeMap*中左旋代码如下:
...
![TreeMap_rotateRight.png](img_Map%20-%20TreeSet%20&%20TreeMap%20%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90/TreeMap_rotateRight.png)*TreeMap*中右旋代码如下:
...
> 2. t的右孩子为空，则t的后继是其**第一个向左走的祖先**。

后继节点在红黑树的删除操作中将会用到。

![TreeMap_successor.png](img_Map%20-%20TreeSet%20&%20TreeMap%20%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90/TreeMap_successor.png)
...
![TreeMap_getEntry.png](img_Map%20-%20TreeSet%20&%20TreeMap%20%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90/TreeMap_getEntry.png)具体代码如下:
...
上述代码的插入部分并不难理解: 首先在红黑树上找到合适的位置，然后创建新的`entry`并插入(当然，**新插入的节点一定是树的叶子**)。难点是**调整函数`fixAfterInsertion()`**，前面已经说过，调整往往需要1.改变某些节点的颜色，2.对某些节点进行旋转。

![TreeMap_put.png](img_Map%20-%20TreeSet%20&%20TreeMap%20%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90/TreeMap_put.png)调整函数`fixAfterInsertion()`的具体代码如下，其中用到了上文中提到的`rotateLeft()`和`rotateRight()`函数。通过代码我们能够看到，情况2其实是落在情况3内的。情况4～情况6跟前三种情况是对称的，因此图解中并没有画出后三种情况，读者可以参考代码自行理解。
...
![TreeMap_fixAfterDeletion.png](img_Map%20-%20TreeSet%20&%20TreeMap%20%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90/TreeMap_fixAfterDeletion.png)
...
- **will:https://blog.csdn.net/u012060033/article/details/121292869**
