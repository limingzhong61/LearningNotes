...
![img](img_JUC%E7%BA%BF%E7%A8%8B%E6%B1%A0%20ScheduledThreadPoolExecutor%E8%AF%A6%E8%A7%A3/java-thread-x-stpe-1.png)
...
- `ScheduledFutureTask`: 继承了FutureTask，说明是一个异步运算任务；最上层分别实现了Runnable、Future、Delayed接口，说明它是一个**可以延迟执行的异步运算任务。**
...
------
 ...
 原文链接：https://pdai.tech/md/java/thread/java-thread-x-juc-executor-ScheduledThreadPoolExecutor.html