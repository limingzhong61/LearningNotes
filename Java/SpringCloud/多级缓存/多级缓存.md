...
详见：  [JVM进程缓存-Caffeine.md](JVM进程缓存-Caffeine.md)
...
接下来，利用Navicat客户端连接MySQL，然后导入相关的sql文件：

项目路径下的 sql\item.sql文件
...
- 项目本地地址：D:\Codes\java\SpringCould\spring-cloud-learning-demo\item-service
